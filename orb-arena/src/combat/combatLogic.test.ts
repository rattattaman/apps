...
import { ContactCooldowns, progressAfterHit, type WeaponProgress } from './combatLogic';
...
describe('progresión de armas', () => {
  it('incrementa solo la estadística distintiva de cada arma', () => {
    ...
    expect(progressAfterHit('dagger', base)).toMatchObject({ damage: 8, angularSpeed: 2.2 });
    expect(progressAfterHit('spear', base)).toMatchObject({ damage: 8.5, range: 60.5 });
